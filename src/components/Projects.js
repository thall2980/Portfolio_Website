...
const projectVideos = [
                        {
                          id : 1,
                          title : "Art Spot",
                          description : "A social media app for artists to post artwork, comment, and like other user’s artwork.",
                          process: [
                         ...
                         },
                        {
                          id : 2,
                          title : "Groove Hound",
                          description : "A concert tracking app that displays upcoming concerts and bands.",
                          process: [
                         ...
                         },
                        {
                          ...
                          description : "A dog walking service where users can register their dogs and create appointments.",
                          process: [
                         ...
                         },
                        {
                          ...
                          description : "An application to display the 2022 League of Legends world tournament information with a message board feature.",
                          process: [
...
const videoComponent = projectVideos.map((projectVideo) => <ProjectVideo key ={projectVideo.id} props = {projectVideo} />)
